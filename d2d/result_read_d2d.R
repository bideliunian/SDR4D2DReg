...
############################### read data ##############################
for (i in 1:100) {
  load(file = paste(save_path,"/wgsir.d2d.",i,".RData",sep=""))
...
library(xtable)
xtable(cbind(rep(c(100, 200), 6), wgsir1.rvmr.m50, wgsir1.rvmr.m100, wgsir2.rvmr.m50, wgsir2.rvmr.m100)
       , digits = 3)

xtable(cbind(rep(c(100, 200), 6), wgsir1.dcor.m50, wgsir1.dcor.m100, wgsir2.dcor.m50, wgsir2.dcor.m100)
       , digits = 3)