########################################################
####   Simulations to compare GSIR using l2 distance with WGSIR  ########
########################################################
...
result_gsir_l2 <- mapply(main_gsir, times = 1, n=grid.result$n, m=grid.result$m,
...
save(result_gsir_l2, file = paste(save_path, "/l2gsir.",args,".RData",sep=""))
